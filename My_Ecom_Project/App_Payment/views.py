...
def payment(request):
    ...
    store_id = 'ownco61a5cdff16f55' 
    API_key= 'ownco61a5cdff16f55@ssl'
...
def complete(request):
    if request.method =='POST' or request.method == 'post':
        ...
        if status== 'VALID':
            ...
            messages.warining(request,f"Your Payment Failed! PLease try again")
...
def order_view(request):
    try:
        ...
        messages.warning(request, "You donot have an active order")
